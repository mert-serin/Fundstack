...
private extension SearchController {
    ...
    func loadItemsFromAPI(for query: String, completion: @escaping FetchSearchResultCompletionBlock) {
        let urlString = String(format: "https://autocomplete.clearbit.com/v1/companies/suggest?query=\(query)").addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!
